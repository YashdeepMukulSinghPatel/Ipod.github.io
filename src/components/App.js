...
// Import songs
import song1 from "../static/songs/Despacito.mp3"
import song2 from "../static/songs/OnMyWay.mp3"
import song3 from "../static/songs/Senorita.mp3"


// Import song cover images
import song1Img from "../static/Despacito.jpg";
import song2Img from "../static/OnMyWay.jpg";
import song3Img from "../static/Senorita.webp";
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      menuItems: ["Cover Flow", "Music", "Games", "Settings"], //menu Items
      musicItems: ["All Songs", "Artists", "Albums"], //Items in music
      songItemsUrl: [song1, song2, song3,],  //songs list
      songImgItemsUrl: [song1Img, song2Img, song3Img,],  //song images list
      wallpaperItems: [Ipod, BlueCubes, BlueJelly], //wallpapers
      songItems: ["Despacito", "OnMyWay", "Senorita",], //song names
